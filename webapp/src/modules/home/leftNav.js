        ...
        <div className="left-nav">
            <div className="banner" style={{padding: "40px 10px"}}>
                <div style={{ position: "relative", marginBottom: "20px" }}>
                    ...
                    <div className="user-name v-m">{props.userInfo && props.userInfo.name}</div>
                ...
                <div>
                    <div style={{ marginBottom: "10px", fontSize: "13px" }}><span className="v-m" style={{width: '70px'}}>签名： </span>你是我的源代码</div>
